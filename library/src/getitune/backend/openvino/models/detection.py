...
from getitune.backend.lightning.models.detection.detectors.rfdetr import _build_coco91_remap_tensor
...
class OVDetectionModel(OVModel):
    ...
    Also provides predict_step() for compatibility with Tracker and other consumers
    ...
    def predict_step(
        ...
        Makes OVDetectionModel compatible with Tracker and other consumers that
        ...
        Returns:
            PredictionBatch with bboxes in original image coordinates.
        """
        images = batch.images
